...
public class Box implements Iterable<Ball> {
     ...
     * maxVolume is usded for setting the limit of the Box
     */
    private BallContainer ballContainer;
    private double maxVolume;
    private Comparator<Ball> cmp;
    /**
    ...
    public Box(double maxVolume) {
        ...
        cmp = new Comparator<Ball>() {
        		public int compare(Ball b1, Ball b2) {
        			Double b1Volume = new Double(b1.getVolume());
        			Double b2Volume = new Double(b2.getVolume());
        			return b1Volume.compareTo(b2Volume);
        		}
        };
    }
    ...
    public Iterator<Ball> getBallsFromSmallest() {
        ...
        Iterator<Ball> iterator = this.ballContainer.iterator();
        while (iterator.hasNext()) {
        		ballList.add(iterator.next());
        }
        Collections.sort(ballList, cmp);
